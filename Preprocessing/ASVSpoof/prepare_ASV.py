...
#         # test_lst = []
#         # with open(verification_pairs_file, encoding="utf-8") as file:
#         #     for line in file:
#         #         print(line)  # Print each line
#         #         test_lst.append(line.rstrip("\n").split(" ")[1])

# #         try:
# #             with open(verification_pairs_file, encoding="utf-8") as file:
# #                 for line in file:
# #                     print(f"Reading line: {line}")  # Print each line
# #                     test_lst.append(line.rstrip("\n").split(" ")[1])
# #         except FileNotFoundError:
# #             print(f"File not found: {verification_pairs_file}")
...
def prepare_csv_enrol_test(data_folders, save_folder, verification_pairs_file):
    ...
    for data_folder in data_folders:
        ...
        for id in enrol_ids:
            audio_id = id.split("/")[1]
            flac = data_folder + "/flac/" + audio_id + ".flac"
        ...
        for id in test_ids:
            ...
            start_sample = 0
            stop_sample = signal.shape[0]
            [spk_id, sess_id, utt_id] = id.split("/")[-2:]
